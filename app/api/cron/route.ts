  ...
  try {
    ...
    const updatedProducts = await Promise.all(
      products.map(async (currentProduct) => {
        ...
        if (!scrapedProduct || scrapedProduct.currentPrice == null) {
          console.log("Scraped product or current price is undefined:", scrapedProduct);
          return currentProduct; // Return current product if scraping fails
        }
